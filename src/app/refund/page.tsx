    ...
    return (
        <div className="container mx-auto py-10">
            ...
            <div className="prose max-w-none">
                <p>
                    At <strong className='text-transparent bg-clip-text bg-gradient-to-r from-[#FD9248] via-[#FA1768] to-[#F001FF]'>TestNix</strong>, we are committed to providing clarity and transparency regarding our policies. Please review our Refund and Cancellation Policy to understand our practices related to refunds, cancellations, and subscription management.
                </p>

                <h2 className="text-2xl font-semibold mt-8 mb-4">Refund Policy</h2>
                <p>
                    We do not offer refunds for any subscriptions or services purchased through <strong className='text-transparent bg-clip-text bg-gradient-to-r from-[#FD9248] via-[#FA1768] to-[#F001FF]'>TestNix</strong>. All sales are final, and refunds will not be provided under any circumstances.
                </p>
                ...
                <p>
                    Subscription billing and management for <strong className='text-transparent bg-clip-text bg-gradient-to-r from-[#FD9248] via-[#FA1768] to-[#F001FF]'>TestNix</strong> are securely handled by <strong>Stripe</strong>, a trusted and reliable payment processing platform. With Stripe, users benefit from:
                </p>
                ...
                <p>
                    Should you have any questions, require further clarification, or encounter issues related to our Refund and Cancellation Policy, please do not hesitate to <a href="/contact">contact us</a>. Our dedicated support team is available to assist you and ensure a positive experience with <strong className='text-transparent bg-clip-text bg-gradient-to-r from-[#FD9248] via-[#FA1768] to-[#F001FF]'>TestNix</strong>.
                </p>
            </div>
        </div>
    )
